...
public class DetailResepActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardListDetailResep = (RecyclerView) findViewById(R.id. cardListDetailResep);
        ...
        Intent i = getIntent();
        String url = "http://rumahsakit.gearhostpreview.com/Rumah_Sakit/selectDetailResep.php?id_resep="+i.getStringExtra("panduanIdResep");
